...
![Capmfire signal smoke going up](./assets/particles/smoke-going-up.webp)
...
![Campfire signal smoke going down](./assets/particles/smoke-going-down.webp)
...
(`someLocation.clone().add(12, 0, 0)`) with a red color and a travel time of 40 ticks:
<Tabs syncKey="spawn-type">
  <TabItem label="ParticleBuilder">
    ```java
    Particle.TRAIL.builder()
      ...
      .offset(2, 2, 2)
      .count(8)
      .data(new Particle.Trail(someLocation.clone().add(12, 0, 0), Color.RED, 40))
      .receivers(32, true)
      .spawn();
    ```
  </TabItem>
  <TabItem label="spawnParticle">
    ...
    someWorld.spawnParticle(
      ...
      8,
      2, 2, 2,
      new Particle.Trail(someLocation.clone().add(12, 0, 0), Color.RED, 40)
    );
    ```
  </TabItem>
</Tabs>
