...
check out the [registry arguments](./registry.mdx).
...
retrieval, the [player profiles argument](./entity-player#player-profiles-argument) is preferred, as it allows by-name lookup.
