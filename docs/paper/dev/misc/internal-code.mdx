...
Using Minecraft internals is not recommended. This is because using internals directly is not guaranteed to be
...
must include the version. For example, `org.bukkit.craftbukkit.v1_20_R1.CraftServer` is the full class and package name
