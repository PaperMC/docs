...
import DoubleRangeGif from "./assets/vanilla-arguments/doublerange.gif"
import EntityOppedGif from "./assets/vanilla-arguments/entity-opped.gif"
import EntityUnoppedGif from "./assets/vanilla-arguments/entity-unopped.gif"
import EntitiesGif from "./assets/vanilla-arguments/entities.gif"
...
### In-game preview
<img style={{width: '100%'}} src={DoubleRangeGif}/>
...
<img style={{width: '100%'}} src={EntityUnoppedGif}/>

If the executing player is opped:
<img style={{width: '100%'}} src={EntityOppedGif}/>
...
## In-game preview
<img style={{width: '100%'}} src={EntitiesGif}/>
