...
In the [command tree docs](./command-tree.mdx) we have looked at the structure of Brigadier commands and how to build up a command tree. 
...
For more information about execution logic, [click here](./command-executors.mdx)
...
<Javadoc name='org.bukkit.entity.Player#setFlySpeed(float)'>`Player#setFlySpeed(float value)`</Javadoc> method only 
...
can read more about these [here](../arguments/minecraft-arguments.mdx)
