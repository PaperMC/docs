...
Alternatively, you can use the library loader with your lifecycle plugin to load the library at runtime. See [here](../getting-started/lifecycle-plugins.mdx#loaders)
