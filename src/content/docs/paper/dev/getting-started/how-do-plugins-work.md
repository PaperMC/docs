...
example, [](jd:paper:org.bukkit.event.player.PlayerJoinEvent) is fired when a player
...
effect of the event. For example, [](jd:paper:org.bukkit.event.player.PlayerMoveEvent)
