...
For more advanced Java tuning, see [Aikar's Flags](../tutorial/aikars-flags.md).

To configure your server, see the [Configuration](../reference/paper-yml.md) page.

## Updating The Server

Updating Paper is simple! See our [Update Tutorial](../tutorial/update.md) for more information.
