...
For these, see `config/command-aliases.yml` (Pending PR merge) {/*[`config/command-aliases.yml`](docs/paper/admin/reference/configuration/command-aliases.mdx)*/}. {/* TODO create other docs page */}
