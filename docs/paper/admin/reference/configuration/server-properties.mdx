...
allow-flight:
  default: 'false'
  description: 'Means that users will not be kicked if they fly whilst in Survival mode. This is likely to occur through
...
enable-jmx-monitoring:
  default: 'false'
  description: 'Exposes an MBean with the Object name "net.minecraft.server:type=Server" and two attributes
...
enable-status:
  default: 'true'
  description: 'Makes the server appear on the server list and also enables listener for getting server
...
entity-broadcast-range-percentage:
  default: '100'
  description: 'Controls how close entities need to be before being sent to clients. Higher values means they''ll
...
force-gamemode:
  default: 'false'
  description: 'Force players to join in the default game mode. This will reset their previous game mode when they
    reconnect.'
...
initial-enabled-packs:
  default: 'vanilla'
  description: 'Comma-separated list of datapacks to be enabled during world creation. Feature packs need
...
level-type:
  ...
  description: 'Defines the type of the world generator. (Allowed values: "normal", "flat", "large_biomes",
    "amplified", "single_biome_surface", "buffet", "default_1_1", "customized")'
max-chained-neighbor-updates:
  default: '1000000'
  description: 'Limits the number of consecutive neighbour updates before skipping subsequent updates. Negative
...
max-tick-time:
  default: '60000'
  description: 'The maximum number of milliseconds a single tick may take before the server watchdog stops the
...
max-world-size:
  default: '29999984'
  description: 'The maximum allowed size of the world radius, in blocks. This only affects the chunks that are
...
online-mode:
  default: 'true'
  description: 'If set to true, the server checks all connecting players against Minecraft''s account database.
...
prevent-proxy-connections:
  default: 'false'
  description: 'If the ISP/AS sent from the server is different from the one from Mojang Studios'' authentication
...
rate-limit:
  default: '0'
  description: 'Sets the maximum allowed number of packets that can be sent before getting kicked. Setting this to 0
    disables the limit.'
rcon.password:
  default: ''
...
require-resource-pack:
  default: 'false'
  description: 'If true, a player must have the given resource pack to connect. They will be kicked if they do not
    have it.'
resource-pack:
  default: ''
...
resource-pack-sha1:
  default: ''
  description: 'The hash of the resource pack, used for verification. This is reccomended to be set to ensure
...
simulation-distance:
  default: '10'
  description: 'Sets the maximum distance from players that living entities may be located in order to be
    updated by the server, measured in chunks in each direction of the player (radius, not diameter).
    If entities are outside of this radius, then they will not be ticked by the server nor will they be
...
spawn-protection:
  default: '16'
  description: 'Used to determine the side length of the spawn protection. The formula of 2x+1 is used. A value of 1
    will result in a side length of 3 **blocks**. Setting this to 0 will disable spawn protection.'
sync-chunk-writes:
  default: 'true'
...
view-distance:
  default: '10'
  description: 'Sets the amount of world data the server sends the client, measured in chunks in each direction
