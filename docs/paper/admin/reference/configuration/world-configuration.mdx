...
environment:
  ...
  mushroom:
    disable-limit:
      default: 'false'
      description: 'Removes the limit on the spread for mushrooms and sets it to the Minecraft
        9 x 9 x 3 shape.'
    spread-limit:
      default: '5'
      description: 'Sets the limit for how far the mushrooms will spread.'
