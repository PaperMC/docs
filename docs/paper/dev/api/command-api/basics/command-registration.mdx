---
slug: /dev/command-api/basics/command-registration
...
**here** (WIP). If you are not using `paper-plugin.yml`, you can instead register your commands inside your plugin's main class.
...
* If you want to read more about lifecycle events, you can check out the **dedicated docs entry** (WIP)