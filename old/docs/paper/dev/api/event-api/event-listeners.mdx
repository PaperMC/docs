...
To listen for events, you need to create a class that implements <Javadoc name={"org.bukkit.event.Listener"}>`Listener`</Javadoc>.
...
To listen for an event, you need to create a method that is annotated with <Javadoc name={"org.bukkit.event.EventHandler"}>`@EventHandler`</Javadoc>.
...
look <Javadoc name={"org.bukkit.event.Event"}>here</Javadoc>
...
These events implement <Javadoc name={"org.bukkit.event.Cancellable"}>`Cancellable`</Javadoc>.
