...
settings:
  ...
  moved-too-quickly-multiplier:
    ...
    description: 'Controls how fast a client can move in one packet.
      If triggered, logs to console and prevents the move.'
...
world-settings:
  default:
    ...
    max-tick-time:
      entity:
        default: '50'
        description: 'This option is a noop, and is non-functional upstream.'
      tile:
        default: '50'
        description: 'This option is a noop, as it is disabled by a paper patch.'
    max-tnt-per-tick:
      default: '100'
    ...
    merge-radius:
      exp:
        default: '3.0'
        description: 'The range in blocks that exp orbs will combine.'
      item:
        default: '2.5'
        description: 'The range in blocks that items will combine.'
    mob-spawn-range:
      default: '8'
    ...
    thunder-chance:
      ...
      description: 'The chance of lightning occurring during a thunderstorm,
        as a 1/<thunder-chance> chance each chunk each tick.'
    ticks-per:
      hopper-check:
        default: '1'
