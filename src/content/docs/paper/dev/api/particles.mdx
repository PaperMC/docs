...
### Base and poof
`GEYSER_BASE` and `GEYSER_POOF` particles function identically, with the only difference being their appearance. They use
...
While this particle uses [`Particle.Geyser`](jd:paper:org.bukkit.Particle$Geyser) as its data,
