...
commands:
  ...
  spam-exclusions:
    default: "[/skill]"
    description: |
      Any chat message or command that prefix matches an entry in this list
  ...
  tab-complete:
    ...
    description: |
      ...
      - \\> 0 only tab-complete commands after n characters are typed.
        This behaves as 0 due to client changes.
messages:
  outdated-client:
    default: Outdated client! Please use {0}
    description: | # TODO when auto-versioned stuff (#212) is merged
      The kick for a player when they can't join,
  ...
  outdated-server: # TODO when auto-versioned stuff (#212) is merged
  ...
  restart:
    ...
    description: |
      The kick message for players on the server when it starts restarting,
      or if a player tries to join while the server is still restarting.
      The message is formatted with legacy "&" style formatting, and "\\n" for newlines.
  server-full:
    default: The server is full!
    description: |
      The kick message for a player when they can't join,
      as the server not having any open slots (current-players >= max players)
      The message is formatted with legacy "&" style formatting, and "\\n" for newlines.
  unknown-command:
    default: Unknown command. Type "/help" for help.
    description: |
      The default message sent to a player, when a command they run is not found by the server
      The message is formatted with legacy "&" style formatting, and "\\n" for newlines.
  whitelist:
...
settings:
  ...
  moved-too-quickly-multiplier:
    default: 10.0
    description: |
      Controls how fast a client can move in one packet.
      If triggered, logs to console and prevents the move.
  moved-wrongly-threshold:
    default: 0.0625
    description: |
      Controls how far the client can move per move-packet,
  ...
  player-shuffle:
    default: "0"
    description: |
      How often to shuffle the list of player connections, in Ticks, with -1 to disable.
  ...
  sample-count:
    default: 12
    description: |
      How many players to display the names of in the player-count hover.
  ...
  timeout-time:
    default: 60
    description: |
      Time in seconds since the last server-tick that the server is deemed not-responding by the server,
...
stats:
  ...
  forced-stats:
    default: "{}"
    description: | # TODO seemingly broken?
      An Object, where:
...
world-settings:
  default:
    ...
    dragon-death-sound-radius:
      default: "0"
      description: |
        The number of blocks that the dragon death sound is audible.
        Set to 0 for global (including cross-dimension).
    enable-zombie-pigmen-portal-spawns:
      default: true
      description: |
        Whether to allow Zombified Piglins to spawn inside Nether Portals.
        This setting does not affect portal travel for any mobs.
    end-portal-sound-radius:
      default: 0
      description: |
        The number of blocks that the end portal opening sound is audible.
        Set to 0 for global (including cross-dimension).
    entity-activation-range:
      ...
      wake-up-inactive:
        animals-every:
          default: 1200
          description: |
            How often an inactive animal outside of range will be woken up, in ticks.
        ...
        flying-monsters-every:
          default: 200
          description: |
            How often an inactive flying monster outside of range will be woken up, in ticks.
        ...
        monsters-every:
          default: 400
          description: |
            How often an inactive monster outside of range will be woken up, in ticks.
        ...
        villagers-every:
          default: 600
          description: |
            How often an inactive villager outside of range will be woken up, in ticks.
    ...
    entity-tracking-range:
      ...
      display:
        default: 128
        description: |
          Controls how far in blocks display entities are tracked (sent to) the player.
          This is scaled by entityBroadcastRangePercentage.
      misc:
        default: 32
        description: |
          Controls how far in blocks misc entities are tracked (sent to) the player.
          This is scaled by entityBroadcastRangePercentage.
      monsters:
        default: 48
        description: |
      ...
      other:
        default: 64
        description: |
          Controls how far in blocks other entities are tracked (sent to) the player.
          This is scaled by entityBroadcastRangePercentage.
      players:
        default: 48
        description: |
    ...
    growth:
      bamboo-modifier:
        default: 100
        description: |
          The growth modifier percentage, where vanilla is 100%.
      beetroot-modifier:
        default: 100
        description: |
          The growth modifier percentage, where vanilla is 100%.
    ...
    hunger:
      ...
      swim-multiplier:
        default: 0.01
        description: |
          The exhaustion multiplier for when "swimming".
    ...
    item-despawn-rate:
      default: 6000
      description: |
        The default time in ticks it takes an item to despawn.
    ...
    simulation-distance:
      default: default
      description: |
        Overrides the Simulation distance
        Set to -1 or "default" to use the value in server.properties
    thunder-chance:
      default: 100000
      description: |
        The chance of lightning occurring during a thunderstorm,
    ...
    view-distance:
      default: default
      description: |
        Overrides the View distance
        Set to -1 or "default" to use the value in server.properties
    wither-spawn-sound-radius:
      default: "0"
      description: |
        The number of blocks that the wither spawn sound is audible.
        Set to 0 for global (including cross-dimension).
