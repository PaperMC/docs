...
import VanillaGlobalDefaults from '!!raw-loader!@site/config-specs/paper/paper-global.yml'
import SpigotChanges from '!!raw-loader!@site/config-specs/paper/spigot.yml'
import ServerProperties from '!!raw-loader!@site/config-specs/paper/server-properties.yml'
...
:::
## server.properties
<ConfigDocBlock data={ServerProperties} vanilla={true}/>

## paper-world-defaults.yml
<ConfigDocBlock data={VanillaWorldDefaults} vanilla={true}/>

## paper-global.yml
<ConfigDocBlock data={VanillaGlobalDefaults} vanilla={true}/>

## spigot.yml
<ConfigDocBlock data={SpigotChanges} vanilla={true}/>
