...
[Per-World Configuration Reference](../reference/configuration/world-configuration.mdx).
...
[`feature-seeds` configuration](../reference/configuration/world-configuration.mdx), in conjunction
