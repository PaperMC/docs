...
// Replace siteTitle with effective plugin (project) name
...
function DocVersionBannerEnabled({
  ...
  return (
    ...
    >
      <div>
        {/* PaperMC/docs - siteTitle is hijacked and changed to id of docs plugin (good enough, best I have. not adding a whole `name` property to content-docs) */}
        <BannerLabel
