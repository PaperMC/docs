...
enable-status:
  default: 'true'
  description: 'Makes the server appear on the server list and also enables the query listener to get server
...
spawn-protection:
  ...
  description: 'Used to determine the side length of the spawn protection. The formula of 2x+1 is used. A value of 1
    will result in a side length of 3 chunks. Setting this to 0 will disable spawn protection.'
sync-chunk-writes:
  default: 'true'
