...
You can find more information about requirements [here](../basics/requirements.mdx).
...
### Example usage
```java
public static LiteralCommandNode<CommandSourceStack> singleEntityArgument() {
...
### Example usage
```java
public static LiteralCommandNode<CommandSourceStack> multipleEntitiesArgument() {
