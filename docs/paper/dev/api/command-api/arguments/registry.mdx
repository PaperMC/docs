...
| BANNER_PATTERN         | PatternType            | [Pattern Type](#pattern-type)               |
| BIOME                  | Biome                  | [Biome](#biome)                             |
| BLOCK                  | BlockType              | [Block Type](#block-type)                   |
| CAT_VARIANT            | Cat.Type               | [Cat Type](#cat-type)                       |
...
| INSTRUMENT             | MusicInstrument        | [Music Instrument](#music-instrument)       |
| ITEM                   | ItemType               | [Item Type](#item-type)                     |
| JUKEBOX_SONG           | JukeboxSong            | [Jukebox Song](#jukebox-song)               |
| MAP_DECORATION_TYPE    | MapCursor.Type         | [Map Cursor Type](#map-cursor-type)         |
| MEMORY_MODULE_TYPE     | MemoryKey\<?>          | [Memory Module Type](#memory-module-type)   |
| MENU                   | MenuType               | [Menu Type](#menu-type)                     |
| MOB_EFFECT             | PotionEffectType       | [Potion Effect Type](#potion-effect-type)   |
| PAINTING_VARIANT       | Art                    | [Art](#art)                                 |
| PARTICLE_TYPE          | Particle               | [Particle](#particle)                       |
| POTION                 | PotionType             | [Potion Type](#potion-type)                 |
